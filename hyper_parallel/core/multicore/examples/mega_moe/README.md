...
See [the DSV4.1 precision example](deepseek_v41_precision.md) for the unclamped
MoE adapter, HF BF16 comparisons and an independent CPU FP32 oracle. This is a
