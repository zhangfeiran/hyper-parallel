...
/**
 * @file hyper_mega_moe_tiling.h
 */
#ifndef HYPER_MEGA_MOE_TILING_H
#define HYPER_MEGA_MOE_TILING_H
#include "register/tilingdata_base.h"
#include "tiling/tiling_api.h"

namespace optiling {
// The selected ops-nn custom host library does not retain the registration
// object from the static tiling_api archive. Register this nested AscendC API
// structure once in the shared HyperMegaMoe/HyperMegaMoeGrad tiling library.
...
BEGIN_TILING_DATA_DEF(HyperMegaMoeTilingData)
